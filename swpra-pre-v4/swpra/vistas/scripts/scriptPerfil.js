...
function cargarEstudianteEnInterfaz(usuario = {}, extras = {}) {
    ...
    limpiarSelector(selectorProgramas);
    limpiarSelector(selectorCuatris);
...
function limpiarSelector(selector = HTMLElement) {
    while (selector.options.length > 1) {
        selector.options.remove(selector.options.length -1);
    }
}
